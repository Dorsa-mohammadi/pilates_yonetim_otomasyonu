...
<div class="container">
  <div class="left-image">
    <img src="../assets/images/yonetici-giris.jpg" alt="Pera Pilates Görseli">
  </div>
  <div class="form-container">
    <h2>Yönetici Girişi</h2>
    <form action="../pages/giris_kontrol.php" method="post">
      <input type="hidden" name="tur" value="admin">
...
<div id="modal">
  <div class="modal-content">
    ...
    <form action="../pages/sifre_mail_gonder.php" method="post">
